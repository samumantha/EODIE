...
parser.add_argument('--polygons', dest='small_poly_file', help='name of the vectorfile to be split ', required=True)
...
sso = TileSplitter(args.small_poly_file, large_poly_file, args.outdir , large_poly_namefield)
sso.tilesplit()
