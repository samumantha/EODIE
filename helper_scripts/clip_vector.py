...
if not os.path.isfile(args.vector):
    exit(
        "ERROR: The input vector does not exist. Please check your inputs."
    )

if args.extent is not None:
    if not os.path.isfile(args.extent):
        exit(
            "ERROR: The extent vector does not exist. Please check your inputs."
        )

if args.dir is not None:
    if not os.path.isdir(args.dir):
        exit(
            "ERROR: The data directory does not exist. Please check your inputs."
        )
