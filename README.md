...
Unused imports of EODIE code have been checked by [Vulture](https://github.com/jendrikseipp/vulture) and the overall code formatting with [Black](https://github.com/psf/black).
